-- chat_participants 테이블의 순환 참조 문제 해결
...
-- 추가 보안을 위한 간단한 정책들도 수정
CREATE OR REPLACE POLICY "Users can send messages to their rooms" ON chat_messages
...
CREATE OR REPLACE POLICY "Users can add reactions" ON message_reactions
    FOR INSERT WITH CHECK (
