-- ========================================
-- 🚀 Coilmaster Corporate System - 안전한 데이터베이스 설치 스크립트
...
SELECT 
    '✅ Coilmaster 데이터베이스 안전 설치 완료!' as "설치 상태",
    'ON CONFLICT 오류 완전 방지' as "오류 방지",
    '에러 없는 안전한 스키마' as "품질 보증",
