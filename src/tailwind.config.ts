		...
		extend: {
			colors: {
				...
				editor: {
					...
					focus: 'rgba(59, 130, 246, 0.2)',       // Focus state for editor elements
					muted: '#f1f5f9',                       // Background for inactive elements
					hover: 'rgba(59, 130, 246, 0.05)'       // Hover state for editor elements
				}
			},
			borderRadius: {
				lg: 'var(--radius)',
