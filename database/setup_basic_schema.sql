...
DROP POLICY IF EXISTS "Allow authenticated users full access" ON public.task_phases;
CREATE POLICY "Allow authenticated users full access" 
...
-- 10. 스키마 설정 완료 (샘플 데이터 제거됨)

-- 완료 메시지
SELECT '✅ 기본 스키마 설정이 완료되었습니다!' as message; 